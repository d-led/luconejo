...
describe("bind_exchange",function()
    ...
    it("",function()
	    assert.True( this.channel:SimpleDeclareExchange("exchange_bind_dest") )
	    assert.True( this.channel:SimpleDeclareExchange("exchange_bind_src") )

	    assert.True( this.channel:BindExchange("exchange_bind_dest", "exchange_bind_src", "rk") )

	    assert.True( this.channel:DeleteExchange("exchange_bind_dest") )
	    assert.True( this.channel:DeleteExchange("exchange_bind_src") )
    end)
end)
...
describe("bind_exchange_badexchange",function()
    ...
    it("",function()
	    ...
	    assert.False( this.channel:BindExchange("exchange_bind_dest", "exchange_bind_notexist", "rk") )
...
describe("unbind_exchange",function()
    ...
    it("",function()
	    ...
	    assert.True( this.channel:BindExchange("exchange_bind_dest", "exchange_bind_src", "rk") )
	    assert.True( this.channel:UnbindExchange("exchange_bind_dest", "exchange_bind_src", "rk") )
...
--     it("",function()
-- 	    assert.False( this.channel:UnbindExchange("exchange_notexist", "exchange_notexist", "notexist") )
--     end)
-- end)
