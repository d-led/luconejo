...
ifeq ($(config),debug32)
  OBJDIR     = ../../../obj/linux/gmake/x32/Debug/luconejo/x32
  TARGETDIR  = ../../..
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L. -L../../../bin/linux/gmake/x32/Debug -shared -m32 -L/usr/lib32
  LDDEPS    += ../../../bin/linux/gmake/x32/Debug/libSimpleAmqpClient.a
  LIBS      += $(LDDEPS) -lrabbitmq -llua5.1 -lboost_system -lpthread -lboost_chrono
...
ifeq ($(config),release32)
  OBJDIR     = ../../../obj/linux/gmake/x32/Release/luconejo/x32
  TARGETDIR  = ../../..
  TARGET     = $(TARGETDIR)/luconejo.so
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L. -L../../../bin/linux/gmake/x32/Release -s -shared -m32 -L/usr/lib32
...
ifeq ($(config),debug64)
  OBJDIR     = ../../../obj/linux/gmake/x64/Debug/luconejo/x64
  TARGETDIR  = ../../..
  TARGET     = $(TARGETDIR)/luconejo.so
  DEFINES   += -DBOOST_NO_VARIADIC_TEMPLATES -DDEBUG -D_DEBUG
  INCLUDES  += -I../../../rabbitmq-c/librabbitmq -I../../../SimpleAmqpClient/src -I../../../LuaBridge-1.0.2 -I../../../SimpleAmqpClient/third-party/gtest-1.7.0 -I/usr/include/lua5.1
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L. -L../../../bin/linux/gmake/x64/Debug -shared -m64 -L/usr/lib64
...
ifeq ($(config),release64)
  OBJDIR     = ../../../obj/linux/gmake/x64/Release/luconejo/x64
  TARGETDIR  = ../../..
  TARGET     = $(TARGETDIR)/luconejo.so
  DEFINES   += -DBOOST_NO_VARIADIC_TEMPLATES -DRELEASE
  INCLUDES  += -I../../../rabbitmq-c/librabbitmq -I../../../SimpleAmqpClient/src -I../../../LuaBridge-1.0.2 -I../../../SimpleAmqpClient/third-party/gtest-1.7.0 -I/usr/include/lua5.1
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L. -L../../../bin/linux/gmake/x64/Release -s -shared -m64 -L/usr/lib64
